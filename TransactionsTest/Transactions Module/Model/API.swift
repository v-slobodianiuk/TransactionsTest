...
public final class TransactionsQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "30fea83303cdb4fdd72154a13630df295b4e25ca294e0fe2d09ebbd154eca7ef"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct DailyTransactionsFeed: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLTypeCase(
            variants: ["TransactionWidget": AsTransactionWidget.selections, "DaySectionWidget": AsDaySectionWidget.selections],
            default: [
